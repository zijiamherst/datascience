...
calendar_data <- "/Users/zijizhou/Downloads/Calendar\ Query_7fhbb7ap32kh844fklt7cca3sc@group.calendar.google.com.ics" %>% 
...
activities <- calendar_data %>% 
  ...
  summarize(duration_mins = sum(duration_sec))
calendar_data
activities
```
